...
export default function Pagelog2() {
    async function fetchData(s) {
        if (s === "log_student") {
            try {
                ...
                const response = await axios.post('https://adaan-pradaan-back-end.vercel.app/api/login', {
                    email,
                    password
                });
                ...
                if (response.status === 200) {
                    ...
                    setCookie("student_email", email, expirationMinutes);
                    setCookie("student_college", college, expirationMinutes);
                    setCookie("student_section", section, expirationMinutes);
                    setCookie("student_year", year, expirationMinutes);
                    setCookie("student_booked", booked, expirationMinutes);
            ...
            try {
                ...
                const response = await axios.post('https://adaan-pradaan-back-end.vercel.app/api/login_management', {
                    email,
                    password,
                    idno
                });
                ...
                if (response.status === 200) {
                    const { email, college, booked, studentbooked } = data;

                    const expirationMinutes = 90;
                    setCookie("college_email", email, expirationMinutes);
                    setCookie("college_college", college, expirationMinutes);
                    setCookie("college_booked", booked, expirationMinutes);
                    setCookie("college_studentbooked", studentbooked, expirationMinutes);
    ...
    function onbuttonclick() {
        ...
        axios.post('https://adaan-pradaan-back-end.vercel.app/api/register', cls, {
            headers: {
    ...
    function sdomr() {
        ...
        axios.post('https://adaan-pradaan-back-end.vercel.app/api/register_management', cls, {
            headers: {
                "Content-Type": "application/json",
            }
        })
        ...
        <>
                ...
                <div className="row">
                    ...
                    <div className="col-6-paina">
                                                    ...
                                                    <div className="loginbo">
                                                        <div className="container-fluid">
                                                            <div className="display-3">
                                                                <div style={{ color: "#DEB887", textDecoration: "none" }} className="logpo" id='axioskiid1' target='_blank' onClick={() => fetchData("log_student")}><b>LOG IN</b></div>
                                                            </div>
                                                        </div>
                                                    </div>
                        ...
                        <div className='container-fluid-opts'>
                            <div className='row'>
                                <div className="col-4"><a href=""><img src="imagesre/google.png" alt="google logo" width="130px" height="100px" /></a></div>
                                <div className="col-4"><center><h1><b>or</b></h1></center></div>
                                <div className="col-4"><a href=""><img src="imagesre/OIP.jpg" alt="logo" width="80px" height="80px" /></a></div>
                            </div>
                        </div>
                        <br />
                        <div className='registeropt' style={{ color: "#DEB887", textDecoration: "none" }} onClick={openregister}><h1>R E G I S T E R</h1></div>
            ...
            <div>
                <div className="yearbox111">
                    <h1 style={{ color: "#ffffff" }} className="yeartext111">Management</h1>
                </div>
                <div className="yearbox112">
                    <h1 style={{ color: "#ffffff" }} className="yeartext112">
                        <Link to={"/Login1"} style={{ color: "#ffffff", textDecoration: "none" }} className="logpo" target='_blank'>log-in</Link>
                    </h1>
                </div>
                <div className='openmanagement' onClick={openman}></div>
                ...
                <div style={{ color: "#ffffff", textDecoration: "none" }} className="logpo" target='_blank' onClick={() => fetchData("n")}>
                    <div className='linktoman' onClick={() => fetchData("n")}>
                        <h3 className='ijkl' id='qaz'>login..</h3>
                    </div>
                </div>
                <div style={{ color: "#ffffff", textDecoration: "none" }} className="logpo" target='_blank'>
                    ...
                    <div id='coverforchangedregistertext' className='coverforchangedregistertext' onClick={() => sdomr()}></div>
                </div>
            </div>
        </>
    );
...
//                 document.getElementById("axioskiid1").addEventListener("click", function(event) {
